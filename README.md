...
| Backend-issued plugin/skill bundle URLs | `client.chatgpt.plugins.bundles` | HTTPS-only bounded downloads plus safe atomic plugin extraction; OAuth is never forwarded to signed URLs. |
